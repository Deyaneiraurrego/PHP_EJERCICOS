        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <button  class="btn btn-success" onclick="ventanaSecundaria('http://localhost:8080/ProyectoPHP/?controller=equipo&method=new')"><i class="fas fa-chart-bar"></i> Equipo</button>
